...
hXT{1} = [ ...
    (y(1)+1) * (-1e-3-y(1));       	% XT_1 = [-1,-1e-3] x [1e-3,1] x [-pi/2,pi/2]
    (y(2)-1e-3) * (1-y(2));
    (pi/2)^2 - y(3)^2 ];
hXT{2} = [ ...
    (y(1)-1e-3) * (1-y(1));       	% XT_2 = [1e-3,1] x [1e-3,1] x [-pi/2,pi/2]
    (y(2)-1e-3) * (1-y(2));
    (pi/2)^2 - y(3)^2 ];
hXT{3} = [ ...
    (y(1)+1) * (-1e-3-y(1));       	% XT_3 = [-1,-1e-3] x [-1,-1e-3] x [-pi/2,pi/2]
    (y(2)+1) * (-1e-3-y(2));
    (pi/2)^2 - y(3)^2 ];
hXT{4} = [ ...
    (y(1)-1e-3) * (1-y(1));       	% XT_4 = [1e-3,1] x [-1,-1e-3] x [-pi/2,pi/2]
    (y(2)+1) * (-1e-3-y(2));
    (pi/2)^2 - y(3)^2 ];
